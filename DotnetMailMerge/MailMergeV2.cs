...
public class MailMergeV2
{
    ...
    //public Result<string, Exception> Render(JsonObject parameters)
    //{
    ...
    //    if (_parameters[b.List] is JsonArray objList)
    //    {
    //        var result = "";
    ...
    //}
    //private Result<string> HandleIfBlockLoop(Block block, JsonNode obj)
    //{
    ...
    ////{ A = 2 }
    //private Result<string> HandleReplaceBlockLoop(Block block, JsonNode val)
    //{
    //    var res = "";
    ...
    //        if (param is JsonNode superParam)
    //        {
